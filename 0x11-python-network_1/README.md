...
0. What's my status? #0 mandatory - [0-hbtn_status.py](0-hbtn_status.py/)
...
1. Response header value #0 mandatory - [1-hbtn_header.py](1-hbtn_header.py/)
...
2. POST an email #0 mandatory - [2-post_email.py](2-post_email.py/)
...
3. Error code #0 mandatory - [3-error_code.py](3-error_code.py/)
...
4. What's my status? #1 mandatory - [4-hbtn_status.py](4-hbtn_status.py/)
...
5. Response header value #1 mandatory - [5-hbtn_header.py](5-hbtn_header.py/)
...
6. POST an email #1 mandatory - [6-post_email.py](6-post_email.py/)
...
7. Error code #1 mandatory - [7-error_code.py](7-error_code.py/)
...
8. Search API mandatory - [8-json_api.py](8-json_api.py/)
...
9. My Github! mandatory - [10-my_github.py](10-my_github.py/)
...
10. Time for an interview! #advanced - [100-github_commits.py](100-github_commits.py/)
...
11. Twitter Auth #advanced - [103-search_twitter.py](103-search_twitter.py/)
